...
const SECTIONS: { h: string; ps: string[] }[] = [
  ...
  },
  {
    ...
    ps: [
      ...
      "Shelters can also connect outside tools through API keys and webhooks (for example Zapier or Make). Data sent to a connected tool is chosen and controlled by the shelter, governed by that tool's own privacy policy, and every connection can be revoked by the shelter at any time.",
    ],
  },
  {
    h: "Where it lives",
